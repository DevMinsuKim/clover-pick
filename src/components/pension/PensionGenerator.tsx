    ...
    <div className="flex flex-col items-center justify-center">
      <div className="mt-8 w-full max-w-lg rounded-xl border bg-content1 text-center shadow-md dark:border-none">
        <div className="px-5">
          ...
          <div className="relative mb-7 mt-3 w-full max-w-lg text-left">
            <div>
              <button
                ...
                type="button"
                className="inline-flex w-full justify-between rounded-md border bg-white px-4 py-2 text-sm font-medium text-foreground shadow-sm hover:bg-content1Hover focus:ring-primary disabled:opacity-40 disabled:hover:bg-white dark:border-none dark:bg-black dark:hover:bg-content1Hover disabled:hover:dark:bg-black"
              >
                {repeatPension}
                <svg
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 z-10 mt-2 w-full origin-top-right rounded-md border bg-white shadow-sm dark:border-none dark:bg-black">
                <div className="p-2">
          ...
          <div className="mb-6 rounded-xl border bg-background p-4 text-left shadow-sm dark:border-none">
