      ...
      {!plan ? (
        ...
        >
          ...
          <textarea
            ...
            className="sentry-mask block max-h-48 min-h-28 w-full resize-y rounded-lg border border-divider bg-background px-4 py-3 text-sm leading-6 text-foreground outline-none placeholder:text-content3 focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:opacity-60"
          />
          <p
            id={`${inputId}-count`}
