...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "클로버픽은 로또와 연금복권 번호를 간편하게 골라보는 서비스예요. 두 복권 모두 랜덤 생성과 원하는 조건을 적용하는 맞춤 생성을 이용할 수 있어요.",
  },
  {
    question: "AI는 어떤 역할을 하나요?",
    answer:
      "맞춤 생성에 입력한 문장을 AI가 번호 조건으로 정리해요. 조건을 확인하면 그 범위 안에서 번호를 무작위로 생성해요. 랜덤 생성과 빠른 조건만 선택하는 경우에는 AI를 호출하지 않아요.",
  },
  {
